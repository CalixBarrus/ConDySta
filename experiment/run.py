...
from intercept.install import get_package_name, install_apk, uninstall_apk
...
def run_apps_for_integration_testing():
    instrumented_fossdroid_apks_dir_path = "/home/calix/programming/ConDySta/data/experiments/2024-09-13-instrument-test-fossdroid/signed_apks"
    instrumented_gpbench_apks_dir_path = "/home/calix/programming/ConDySta/data/experiments/2024-09-13-instrument-test-gpbench/signed_apks"
    # for instrumented_fossdroid_apks_dir_path in apks_dir_paths:
    #     run_apps_for_integration_testing_generic(instrumented_fossdroid_apks_dir_path, experiment_name, )

    apks_subset = [0,1]
    # apks_subset = None

    for instrumented_fossdroid_apks_dir_path, name in [(instrumented_fossdroid_apks_dir_path, "fossdroid"), (instrumented_gpbench_apks_dir_path, "gpbench")]:
        description = f"Running instrumented apps from {name} benchmark"
        run_apps_for_integration_testing_generic(instrumented_fossdroid_apks_dir_path, "execution-test-" + name, description, apks_subset)
